...
<form  className=' absolute top-7 left-1/3 lg:w-1/3 hidden lg:inline md:w-1/2 sm:w-1/2'>   
    ...
    <div className="relative">
        ...
        <button type="submit"  onClick={handleSearch} className="text-white absolute right-2.5 bottom-2.5 bg-pink-400 hover:bg-pink-300   font-medium rounded-lg text-sm px-4 py-2  ">Search here</button>
...
<form className=' lg:hidden md:w-full '>
               ...
               <div className="relative">
                   ...
                   <button type="submit" onClick={handleSearch} className="text-white absolute right-2.5 bottom-2.5 bg-pink-400 hover:bg-pink-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
               </div>
</form>
</div>
